...
namespace Ludo.Game.Utils
{
    public static class StandardBoard
    {
        ...
        {
            MarkLine(tiles, new[] { new Position(7, 7) }, Zone.Goal, null, true);
        }
        ...
        private static void MarkStandardFinishTiles(Tile[,] tiles)
        {
            MarkFinish(tiles, Color.Red,
                positions: Enumerable.Range(8, 6).Select(r => new Position(r, 7)));
            MarkFinish(tiles, Color.Blue,
                positions: Enumerable.Range(1, 6).Select(c => new Position(7, c)));
            MarkFinish(tiles, Color.Yellow,
                positions: Enumerable.Range(1, 6).Select(r => new Position(r, 7)));
            MarkFinish(tiles, Color.Green,
                positions: Enumerable.Range(8, 6).Select(c => new Position(7, c)));
        }
        ...
        private static List<Position> CreateRedPathPositions()
        {
            return new List<Position>
            {
                ...
                // FINISH
                new(14,7), new(13,7), new(12,7), new(11,7), new(10,7), new(9,7), new(8,7),
                // GOAL
                new(7,7)
            };
        }
